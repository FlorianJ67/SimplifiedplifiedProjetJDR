 ...
 */
final class Version20230822143938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, perso_id INT NOT NULL, contenu VARCHAR(255) NOT NULL, INDEX IDX_67F068BCA76ED395 (user_id), INDEX IDX_67F068BC1221E019 (perso_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE objet (id INT AUTO_INCREMENT NOT NULL, perso_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, valeur VARCHAR(255) DEFAULT NULL, INDEX IDX_46CD4C381221E019 (perso_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE objet ADD CONSTRAINT FK_46CD4C381221E019 FOREIGN KEY (perso_id) REFERENCES perso (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE objet DROP FOREIGN KEY FK_46CD4C381221E019');
