 ...
 */
final class Version20231022183255 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE action (id INT AUTO_INCREMENT NOT NULL, personnage_id INT NOT NULL, caracteristique_id INT DEFAULT NULL, competence_id INT DEFAULT NULL, objet_id INT DEFAULT NULL, dice VARCHAR(255) NOT NULL, dice_score INT NOT NULL, INDEX IDX_47CC8C925E315342 (personnage_id), INDEX IDX_47CC8C921704EEB7 (caracteristique_id), INDEX IDX_47CC8C9215761DAB (competence_id), INDEX IDX_47CC8C92F520CF5A (objet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE caracteristique_perso (id INT AUTO_INCREMENT NOT NULL, caracteristique_id INT NOT NULL, perso_id INT NOT NULL, valeur INT NOT NULL, INDEX IDX_A3E653BF1704EEB7 (caracteristique_id), INDEX IDX_A3E653BF1221E019 (perso_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE competence_perso (id INT AUTO_INCREMENT NOT NULL, competence_id INT NOT NULL, perso_id INT NOT NULL, valeur INT NOT NULL, INDEX IDX_3740ABC715761DAB (competence_id), INDEX IDX_3740ABC71221E019 (perso_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE action ADD CONSTRAINT FK_47CC8C925E315342 FOREIGN KEY (personnage_id) REFERENCES perso (id)');
        $this->addSql('ALTER TABLE action ADD CONSTRAINT FK_47CC8C921704EEB7 FOREIGN KEY (caracteristique_id) REFERENCES caracteristique (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE action DROP FOREIGN KEY FK_47CC8C925E315342');
        $this->addSql('ALTER TABLE action DROP FOREIGN KEY FK_47CC8C921704EEB7');
        $this->addSql('ALTER TABLE action DROP FOREIGN KEY FK_47CC8C9215761DAB');
